...
namespace MuseumExhibits.Infrastructure.Migrations
{
    ...
    [Migration("20260530123132_RemovePostCategory")]
    partial class RemovePostCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollectionExhibit", b =>
                {
                    ...
                    b.HasKey("CollectionsId", "ExhibitsId");

                    b.HasIndex("ExhibitsId");

                    b.ToTable("CollectionExhibits", (string)null);
                });
            ...
            modelBuilder.Entity("MuseumExhibits.Core.Models.Collection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MuseumExhibits.Core.Models.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CollectionExhibit", b =>
                {
                    b.HasOne("MuseumExhibits.Core.Models.Collection", null)
                        .WithMany()
                        .HasForeignKey("CollectionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MuseumExhibits.Core.Models.Exhibit", null)
                        .WithMany()
