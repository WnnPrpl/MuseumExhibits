...
{
    public class ExhibitRepository(MuseumExhibitsDbContext context) : IExhibitRepository
    {
        ...
        private static IQueryable<Exhibit> ApplyFiltering(IQueryable<Exhibit> query, ExhibitFilter filter)
        {
        ...
        private static IQueryable<Exhibit> ApplySorting(IQueryable<Exhibit> query, ExhibitFilter filter) =>
